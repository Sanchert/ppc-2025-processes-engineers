...
- Наблюдается ухудшение времени при увеличении количества процессов, что объясняется реализацией: низкозатратные вычисления не перекрывают накладных расходов на организацию сообщений между процессами — `MPI_Allreduce()`.
